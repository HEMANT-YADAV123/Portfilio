  ...
  return (
    <div className='w-full lg:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-6 lg:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center'>
        ...
        <div className='flex flex-col gap-4'>
            ...
            <p className='text-base text-gray-400 tracking-wide'>Passionate about crafting responsive and user-centric web applications, with a strong foundation in MERN Stack. Open to new opportunities where I can contribute to impactful projects and further develop my skills.
            </p>
            ...
            <p className='text-base text-gray-400 flex items-center gap-2'>
                Email:{" "}
                <span className='text-lightText'>hy700793@gmail.com</span>
            </p>
        </div> 
